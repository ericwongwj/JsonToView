...
public class JasonHelper {
    public static JSONObject getStyles(JSONObject component, Context root_context) {
        ...
        try {
            if (component.has("class")) {
                ...
                for(int i = 0 ; i < style_classes.length ; i++){
                    JSONObject astyle =new JSONObject(); //(Activity) root_context).model.jason.getJSONObject("$jason").getJSONObject("head").getJSONObject("styles").getJSONObject(style_classes[i]);
    ...
    public static JSONObject getLayout(JSONObject component, Context root_context){
    ...
    public static String readFileToString(String filename, Context context) throws IOException {
    ...
    public static Object readLocalJsonToObj(String fn, Context context) {// throws IOException {

        String filename= fn.replace("jsons://","jsons/");
    ...
    public static String readLocalJsonToString(String fn, Context context) {// throws IOException {
